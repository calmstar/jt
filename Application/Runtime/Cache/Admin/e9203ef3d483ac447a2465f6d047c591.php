...
<div class="container">
    ...
    <b>下载导入EXCEL格式示例：</b>  <a href="/Public/Admin/excel/dou_demo.xlsx">点击此处下载</a>
    ...
    <div class="row">
        <div class="col-sm-6">
            <form class="form-inline" role="form" method="post" action="/manager.php/Question/dou_import"  enctype="multipart/form-data">
                <div class="form-group">
                    <label class="sr-only" for="inputfile">文件输入</label>
                    <input type="file" id="inputfile" name="dou_file" >
                </div>
    ...
    <b>图片模板示例：</b>
    <img src="/Public/Admin/img/double.png" alt="导入双选题模板示例"  >
