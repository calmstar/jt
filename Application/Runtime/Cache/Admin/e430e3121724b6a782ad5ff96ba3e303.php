                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <div id="toolbar" class="btn-group">
                            ...
                            <a id="import" type="button" class="btn btn-default" title="导入判断题" onclick="import_jud()">
                                <i class="glyphicon glyphicon-import"></i> EXCEL导入
                            </a>
                        </div>
                        <!--使用了data-toggle='table' id就没效果-->
                        <table id="jud_table" data-url="/manager.php/Question/jud_showlist.html"></table>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#dele').on('click',function(){
                //整理数据
                var idObj = $("#jud_table").bootstrapTable('getSelections');
                var ids = '';
        ...
        function import_jud() {
            layer.open({
                ...
                fixed: false, //不固定
                maxmin: true,
                content: '/manager.php/Question/jud_import',
            });
        }
    </script>
