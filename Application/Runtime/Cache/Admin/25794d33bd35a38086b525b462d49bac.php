            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <form id="paper" action="/manager.php/Paper/add_fixed" class="wizard-big" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                <div class="row">
                                    <h2>请注意：</h2>
                                    <p>指定出卷中：点击完成后页面会自动跳转到 选择试题 页面，请勾选试卷试题。
                                    </p>
                                    <p>
                                        注，‘选择试题’ 页面：① 自动列出了符合所选课程题目。    ② 不论是否展现在练习题中的 试题都会被列出来，由出题者自由选择。  ③ 难度对应的题目数量由出题者自己选择。
                                    </p>
                                </div>
                            </fieldset>
                        </form>
