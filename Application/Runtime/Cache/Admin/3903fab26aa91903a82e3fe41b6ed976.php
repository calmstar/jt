			...
			<div class="col-sm-10 col-sm-offset-1">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="stu" action="/manager.php/Student/add" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">学号：</label>
                                <div class="col-sm-8">
                                    <input id="stuNumber" name="stuNumber" class="form-control" type="text">   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请输入6-16位密码</span> 
                                </div>   
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请确认密码</span> 
                                </div>   
                            </div>
							<div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="xueyuan" id="xueyuan" class="form-control">
                                        ...
                                        <option selected="selected" value="计算机学院">计算机学院</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="stuClass" name="stuClass" class="form-control" type="text" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="zhuanye" name="zhuanye" class="form-control" type="text" >
