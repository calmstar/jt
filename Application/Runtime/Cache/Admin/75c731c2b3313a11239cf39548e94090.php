...
<div class="container">
    ...
    <b>下载导入EXCEL格式示例：</b>  <a href="/Public/Admin/excel/sub_demo.xlsx">点击此处下载</a>
    ...
    <div class="row">
        <div class="col-sm-6">
            <form class="form-inline" role="form" method="post" action="/manager.php/Question/sub_import"  enctype="multipart/form-data">
                <div class="form-group">
                    <label class="sr-only" for="inputfile">文件输入</label>
                    <input type="file" id="inputfile" name="sub_file" >
                </div>
    ...
    <b>图片模板示例：</b>
    <img src="/Public/Admin/img/subject.png" alt="导入主观题模板示例"  >
