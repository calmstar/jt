                                ...
                                <div class="row" id="ques_info">
                                    <div class="col-sm-2" id="sin">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="sin_easy_num" name="sin_easy_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>一般 * 单选题数量</label>
                                            <input id="sin_com_num" name="sin_com_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>困难 * 单选题数量</label>
                                            <input id="sin_diff_num" name="sin_diff_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2" id="dou">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="dou_easy_num" name="dou_easy_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>一般 * 双选题数量</label>
                                            <input id="dou_com_num" name="dou_com_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>困难 * 双选题数量</label>
                                            <input id="dou_diff_num" name="dou_diff_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2" id="jud">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="jud_easy_num" name="jud_easy_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>一般 * 判断题数量</label>
                                            <input id="jud_com_num" name="jud_com_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>困难 * 判断题数量</label>
                                            <input id="jud_diff_num" name="jud_diff_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2" id="sub">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="sub_easy_num" name="sub_easy_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>一般 * 主观题数量</label>
                                            <input id="sub_com_num" name="sub_com_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                        <div class="form-group">
                                            <label>困难 * 主观题数量</label>
                                            <input id="sub_diff_num" name="sub_diff_num" type="text" class="form-control required digits" max="100">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
