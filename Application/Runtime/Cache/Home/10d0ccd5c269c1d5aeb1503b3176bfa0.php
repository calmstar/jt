...
<body class="gray-bg" >
        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1 animated fadeInUp" style="background: white;">
                ...
                <div class="page-header text-success">
                    <h3>【单选题】<small><?php echo ($cou_name); ?></small></h3>
                </div>
                ...
                <div class="answ">
                    <div class="radio">
                        <label>
                            <input type="radio" name="sin" value="<?php echo ($info[0]["is_op1"]); ?>" onclick="check(this.value)">
                            A. <?php echo ($info[0]["op1"]); ?>
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sin" value="<?php echo ($info[0]["is_op2"]); ?>" onclick="check(this.value)">B. <?php echo ($info[0]["op2"]); ?>
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sin" value="<?php echo ($info[0]["is_op3"]); ?>" onclick="check(this.value)">C. <?php echo ($info[0]["op3"]); ?>
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sin" value="<?php echo ($info[0]["is_op4"]); ?>" onclick="check(this.value)">
                            D. <?php echo ($info[0]["op4"]); ?>
                        </label>
                    </div>
                    <span id="tips"></span>
                </div>
    ...
    <script type="text/javascript">
        function check(val){
            ...
            $.ajax({
                type:"POST",
                url:"/index.php/Practice/check_sin",
                data:{sin:val}, //获取表单的所有数据
